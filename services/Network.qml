...
Singleton {
    ...
    property string materialSymbol: ethernet ? "lan" :
        ...
        Network.networkStrength > 60 ? "network-wireless-signal-good" :
        Network.networkStrength > 40 ? "network-wireless-signal-ok" :
        Network.networkStrength > 20 ? "network-wireless-signal-weak" :
        "signal_wifi_0_bar"
    ) : "signal_wifi_off"
